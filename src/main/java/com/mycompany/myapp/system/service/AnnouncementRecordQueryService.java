...
public class AnnouncementRecordQueryService implements QueryService<AnnouncementRecord> {
    ...
    private QueryWrapper<AnnouncementRecord> createQueryWrapper(
        ...
        if (criteria != null) {
            ...
            Map<QueryWrapper<AnnouncementRecord>, Map<String, Object>> queryWrapperMapMap = criteriaToWrapper(
                criteria,
                AnnouncementRecord.class
            );
            Map.Entry<QueryWrapper<AnnouncementRecord>, Map<String, Object>> queryWrapperMapEntry = queryWrapperMapMap
                .entrySet()
                .stream()
                .findFirst()
                .orElseThrow();
            ...
            if (MapUtils.isNotEmpty(fieldMap)) {
                ...
                QueryWrapper<AnnouncementRecord> finalQueryWrapper = queryWrapper;
    ...
    private QueryWrapper<AnnouncementRecord> createQueryWrapperNoJoin(
        QueryWrapper<AnnouncementRecord> queryWrapper,
        Boolean useOr,
        AnnouncementRecordCriteria criteria
    ) {
        if (criteria != null) {
            ...
            Map<QueryWrapper<AnnouncementRecord>, Map<String, Object>> queryWrapperMapMap = criteriaToWrapperNoJoin(
                criteria,
                AnnouncementRecord.class
            );
            Map.Entry<QueryWrapper<AnnouncementRecord>, Map<String, Object>> queryWrapperMapEntry = queryWrapperMapMap
