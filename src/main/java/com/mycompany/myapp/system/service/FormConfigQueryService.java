...
public class FormConfigQueryService implements QueryService<FormConfig> {
    ...
    private QueryWrapper<FormConfig> createQueryWrapper(QueryWrapper<FormConfig> queryWrapper, Boolean useOr, FormConfigCriteria criteria) {
        if (criteria != null) {
            if (useOr == null) {
                useOr = false;
            }
            Map<QueryWrapper<FormConfig>, Map<String, Object>> queryWrapperMapMap = criteriaToWrapper(criteria, FormConfig.class);
            Map.Entry<QueryWrapper<FormConfig>, Map<String, Object>> queryWrapperMapEntry = queryWrapperMapMap
                .entrySet()
                .stream()
                .findFirst()
                .orElseThrow();
            ...
            if (MapUtils.isNotEmpty(fieldMap)) {
                ...
                QueryWrapper<FormConfig> finalQueryWrapper = queryWrapper;
    ...
    private QueryWrapper<FormConfig> createQueryWrapperNoJoin(
        QueryWrapper<FormConfig> queryWrapper,
        Boolean useOr,
        ...
        if (criteria != null) {
            ...
            Map<QueryWrapper<FormConfig>, Map<String, Object>> queryWrapperMapMap = criteriaToWrapperNoJoin(criteria, FormConfig.class);
            Map.Entry<QueryWrapper<FormConfig>, Map<String, Object>> queryWrapperMapEntry = queryWrapperMapMap
                .entrySet()
                .stream()
                .findFirst()
    ...
    public List<Map<String, Object>> statsByAggregateCriteria(FormConfigCriteria criteria) {
        ...
        if (criteria.getFormKey() != null) {
            getAggregateAndGroupBy(criteria.getFormKey(), "form_key", selectFields, groupByFields);
        }
        if (criteria.getFormName() != null) {
            getAggregateAndGroupBy(criteria.getFormName(), "form_name", selectFields, groupByFields);
        }
        ...
        if (CollectionUtils.isNotEmpty(selectFields)) {
            ...
            return formConfigRepository.selectMaps(queryWrapper);
        }
