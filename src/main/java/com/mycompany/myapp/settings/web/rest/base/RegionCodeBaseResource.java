...
import com.mycompany.myapp.settings.service.RegionCodeQueryService;
import com.mycompany.myapp.settings.service.RegionCodeService;
import com.mycompany.myapp.settings.service.criteria.RegionCodeCriteria;
 ...
 * 管理实体{@link com.mycompany.myapp.settings.domain.RegionCode}的REST Controller。
 */
public class RegionCodeBaseResource {
    ...
    public ResponseEntity<RegionCodeDTO> createRegionCode(@RequestBody RegionCodeDTO regionCodeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/region-codes/" + result.getId()))
