...
import com.mycompany.myapp.domain.enumeration.SortValueOperateType;
import com.mycompany.myapp.settings.domain.Dictionary;
import com.mycompany.myapp.settings.repository.DictionaryRepository;
import com.mycompany.myapp.settings.service.DictionaryQueryService;
import com.mycompany.myapp.settings.service.DictionaryService;
 ...
 * 管理实体{@link com.mycompany.myapp.settings.domain.Dictionary}的REST Controller。
 */
