...
/**
 * Criteria class for the {@link com.mycompany.myapp.settings.domain.SiteConfig} entity. This class is used
 * in {@link com.mycompany.myapp.settings.web.rest.SiteConfigResource} to receive all the possible filtering options from
