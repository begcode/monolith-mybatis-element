...
/**
 * Criteria class for the {@link com.mycompany.myapp.settings.domain.SysFillRule} entity. This class is used
 * in {@link com.mycompany.myapp.settings.web.rest.SysFillRuleResource} to receive all the possible filtering options from
