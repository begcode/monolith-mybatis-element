...
/**
 * Criteria class for the {@link com.mycompany.myapp.settings.domain.RegionCode} entity. This class is used
 * in {@link com.mycompany.myapp.settings.web.rest.RegionCodeResource} to receive all the possible filtering options from
