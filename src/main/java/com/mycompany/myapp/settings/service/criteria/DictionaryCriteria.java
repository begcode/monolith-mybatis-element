...
/**
 * Criteria class for the {@link com.mycompany.myapp.settings.domain.Dictionary} entity. This class is used
 * in {@link com.mycompany.myapp.settings.web.rest.DictionaryResource} to receive all the possible filtering options from
