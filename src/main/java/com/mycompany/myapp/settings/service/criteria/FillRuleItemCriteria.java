...
/**
 * Criteria class for the {@link com.mycompany.myapp.settings.domain.FillRuleItem} entity. This class is used
 * in {@link com.mycompany.myapp.settings.web.rest.FillRuleItemResource} to receive all the possible filtering options from
