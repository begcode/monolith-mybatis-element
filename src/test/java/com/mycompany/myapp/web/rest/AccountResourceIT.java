...
class AccountResourceIT {
    ...
    @Test
    @WithMockMyUser(TEST_USER_LOGIN)
    ...
    void testRegisterValid() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singletonList).ifPresent(validUser::setAuthorities);
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singletonList).ifPresent(invalidUser::setAuthorities);
    ...
    private static ManagedUserVM createInvalidUser(
        ...
        invalidUser.setImageUrl("http://placehold.it/50x50");
        invalidUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        invalidUser.setAuthorities(List.of(new AuthorityDTO().code(AuthoritiesConstants.USER)));
        return invalidUser;
    }
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singletonList).ifPresent(firstUser::setAuthorities);
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        authorityService.findFirstByCode(AuthoritiesConstants.ADMIN).map(Collections::singletonList).ifPresent(validUser::setAuthorities);
    ...
    void testSaveAccount() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.ADMIN).map(Collections::singletonList).ifPresent(userDTO::setAuthorities);
    ...
    @Test
    @Transactional
    @WithMockMyUser("save-invalid-email")
    ...
    @Test
    @Transactional
    @WithMockMyUser("save-existing-email")
    ...
    @Test
    @Transactional
    @WithMockMyUser("save-existing-email-and-login")
    ...
    @Test
    @Transactional
    @WithMockMyUser("change-password-wrong-existing-password")
    ...
    @Test
    @Transactional
    @WithMockMyUser("change-password")
    ...
    @Test
    @Transactional
    @WithMockMyUser("change-password-too-small")
    ...
    @Test
    @Transactional
    @WithMockMyUser("change-password-too-long")
    ...
    @Test
    @Transactional
    @WithMockMyUser("change-password-empty")
