...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      children: async params => (await apiService.system.viewPermissionService.tree(params)).records,
      parent: async params => (await apiService.system.viewPermissionService.tree(params)).records,
    ...
    const formGroup = reactive([
      {
        title: props.containerType === 'router' ? '可视权限' : null,
        operation: [],
        component: {
          name: 'el-form',
          props: {
