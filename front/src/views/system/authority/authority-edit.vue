...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      children: async params => (await apiService.system.authorityService.tree(params)).records,
      viewPermissions: async params => (await apiService.system.viewPermissionService.tree(params)).records,
      apiPermissions: async params => (await apiService.system.apiPermissionService.tree(params)).records,
      parent: async params => (await apiService.system.authorityService.tree(params)).records,
      users: async params => (await apiService.system.userService.retrieve(params)).records,
      department: async params => (await apiService.settings.departmentService.tree(params)).records,
    };
    ...
    const formGroup = reactive([
      {
        title: props.containerType === 'router' ? '角色' : null,
        operation: [],
        component: {
          name: 'el-form',
          props: {
