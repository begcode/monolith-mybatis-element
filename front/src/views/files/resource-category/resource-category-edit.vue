...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      children: async params => (await apiService.files.resourceCategoryService.tree(params)).records,
      parent: async params => (await apiService.files.resourceCategoryService.tree(params)).records,
      images: async params => (await apiService.files.uploadImageService.retrieve(params)).records,
      files: async params => (await apiService.files.uploadFileService.retrieve(params)).records,
    };
