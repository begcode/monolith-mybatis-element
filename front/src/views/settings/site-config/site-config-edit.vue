...
import { Icon, Form, ContentWrap, getButtonConfig } from '@begcode/components';
...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      items: async params => (await apiService.settings.commonFieldDataService.retrieve(params)).records,
    };
    ...
    const formGroup = reactive([
      {
        title: props.containerType === 'router' ? '网站配置' : null,
        operation: [],
        component: {
          name: 'el-form',
          props: {
