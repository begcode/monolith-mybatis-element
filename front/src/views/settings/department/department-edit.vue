...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      children: async params => (await apiService.settings.departmentService.tree(params)).records,
      authorities: async params => (await apiService.system.authorityService.tree(params)).records,
      parent: async params => (await apiService.settings.departmentService.tree(params)).records,
