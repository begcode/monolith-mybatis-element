...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      children: async params => (await apiService.settings.regionCodeService.tree(params)).records,
      parent: async params => (await apiService.settings.regionCodeService.tree(params)).records,
    };
    ...
    const formGroup = reactive([
      {
        title: props.containerType === 'router' ? '行政区划码' : null,
        operation: [],
        component: {
          name: 'el-form',
          props: {
