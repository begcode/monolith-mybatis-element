...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      siteConfig: async params => (await apiService.settings.siteConfigService.retrieve(params)).records,
      dictionary: async params => (await apiService.settings.dictionaryService.retrieve(params)).records,
    };
    ...
    const formGroup = reactive([
      {
        title: props.containerType === 'router' ? '通用字段数据' : null,
        operation: [],
        component: {
          name: 'el-form',
          props: {
