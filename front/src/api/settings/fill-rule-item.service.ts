...
export default {
  ...
  retrieveNoPage(paginationQuery?: any): Promise<IFillRuleItem[]> {
  ...
  update(fillRuleItem: IFillRuleItem, batchIds?: number[], batchFields?: String[]): Promise<IFillRuleItem> {
    ...
    return request.put({ url: `${apiUrl}/${fillRuleItem.id}?${queryParams}`, data: fillRuleItem });
  },
