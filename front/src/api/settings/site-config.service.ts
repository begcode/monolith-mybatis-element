...
export default {
  ...
  retrieveNoPage(paginationQuery?: any): Promise<ISiteConfig[]> {
  ...
  update(siteConfig: ISiteConfig, batchIds?: number[], batchFields?: String[]): Promise<ISiteConfig> {
    ...
    return request.put({ url: `${apiUrl}/${siteConfig.id}?${queryParams}`, data: siteConfig });
  },
