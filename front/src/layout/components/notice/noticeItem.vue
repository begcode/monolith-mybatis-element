...
import { ElTag, ElTooltip, ElAvatar } from 'element-plus';
...
<template>
  <div class="notice-container border-b-[1px] border-solid border-[#f0f0f0] dark:border-[#303030]">
    <ElAvatar v-if="props.noticeItem.avatar" :size="30" :src="props.noticeItem.avatar" class="notice-container-avatar" />
    <div class="notice-container-text">
      <div class="notice-text-title text-[#000000d9] dark:text-white">
        ...
        <ElTag v-if="props.noticeItem?.extra" :type="props.noticeItem?.status" size="small" class="notice-title-extra">
