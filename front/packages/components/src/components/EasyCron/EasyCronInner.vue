<template>
  <div :class="`${prefixCls}`">
    <div class="content">
      ...
      <!-- 执行时间预览 -->
      <ElRow :gutter="8">
        <ElCol :span="18" style="margin-top: 22px">
          <ElRow :gutter="8">
            <ElCol :span="8" style="margin-bottom: 12px">
              <ElInput v-model:value="inputValues.second" @blur="onInputBlur">
            ...
            <ElCol :span="8" style="margin-bottom: 12px">
              <ElInput v-model:value="inputValues.minute" @blur="onInputBlur">
                <template #addonBefore>
            ...
            <ElCol :span="8" style="margin-bottom: 12px">
              <ElInput v-model:value="inputValues.hour" @blur="onInputBlur">
                <template #addonBefore>
            ...
            <ElCol :span="8" style="margin-bottom: 12px">
              <ElInput v-model:value="inputValues.day" @blur="onInputBlur">
                <template #addonBefore>
            ...
            <ElCol :span="8" style="margin-bottom: 12px">
              <ElInput v-model:value="inputValues.month" @blur="onInputBlur">
                <template #addonBefore>
            ...
            <ElCol :span="8" style="margin-bottom: 12px">
              <ElInput v-model:value="inputValues.week" @blur="onInputBlur">
                <template #addonBefore>
            ...
            <ElCol :span="8">
              <ElInput v-model:value="inputValues.year" @blur="onInputBlur">
                <template #addonBefore>
            ...
            <ElCol :span="16">
              <Input v-model:value="inputValues.cron" @blur="onInputCronBlur">
                <template #addonBefore>
                  <ElTooltip title="Cron表达式">式</ElTooltip>
                </template>
              </Input>
            </ElCol>
          </ElRow>
        ...
        <ElCol :span="6">
          <div>近十次执行时间（不含年）</div>
          <ElInput type="textarea" :value="preTimeList" :rows="5" />
        </ElCol>
      </ElRow>
    </div>
  </div>
...
import { ElRow, ElCol, ElInput, ElTooltip, ElTabs, ElTabPane, ElDivider } from 'element-plus';
...
import { dateFormat, simpleDebounce } from '@/utils';
